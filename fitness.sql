...
-- ----------------------------
-- Table structure for yoshop_recharge
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_recharge`;
CREATE TABLE `yoshop_recharge` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '充值类型 0 积分 1现金',
  `create_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 充值  1 订单使用',
  `mode` varchar(10) NOT NULL DEFAULT '' COMMENT 'inc 增加 dec 减少',
  ...
  `op_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 后台操作 1用户消费',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_recharge
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_recharge` VALUES (1, 0, 0, '0', 2000.00, '', 1559346104, 10001, 10001, 10006, 0);
INSERT INTO `yoshop_recharge` VALUES (2, 0, 0, '0', -100.00, '', 1559346115, 10001, 10001, 10006, 0);
INSERT INTO `yoshop_recharge` VALUES (3, 0, 0, '0', 200.00, '', 1559346189, 10001, 10001, 10006, 0);
INSERT INTO `yoshop_recharge` VALUES (4, 0, 0, '0', -400.00, '', 1559346208, 10001, 10001, 10006, 0);
INSERT INTO `yoshop_recharge` VALUES (5, 0, 0, 'inc', 300.00, 'hello', 1559346280, 10001, 10001, 10006, 0);
INSERT INTO `yoshop_recharge` VALUES (6, 0, 0, 'inc', 600.00, 'e33', 1559395058, 10001, 10001, 10007, 0);
INSERT INTO `yoshop_recharge` VALUES (7, 0, 1, 'dec', 10.00, '订单：190614183291815使用积分', 1560508364, 0, 10001, 10007, 0);
COMMIT;
...
INSERT INTO `yoshop_setting` VALUES ('store', '商城设置', '{\"name\":\"\\u9177\\u52a8\\u95e8\\u5e97\"}', 10001, 1560501980);
...
-- ----------------------------
-- Table structure for yoshop_shop
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_shop`;
CREATE TABLE `yoshop_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shop_name` varchar(255) NOT NULL DEFAULT '',
  `logo` varchar(255) NOT NULL DEFAULT '',
  `linkman` varchar(40) NOT NULL DEFAULT '',
  `mobile` varchar(40) NOT NULL DEFAULT '',
  `shop_hours` varchar(60) NOT NULL DEFAULT '',
...
-- ----------------------------
-- Records of yoshop_shop
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_shop` VALUES (2, '爱琴海', 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg', 'vilay', '13444', '8:30-17:30', 0, 0, 0, '爱', '3334', 15, 1, 1559351405, 1562278133, 10001, 10003, 1172);
INSERT INTO `yoshop_shop` VALUES (3, '签语', 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg', '33', '33', '33', 0, 0, 0, '33', '33', 100, 1, 1559356240, 1559356240, 10001, 0, 0);
INSERT INTO `yoshop_shop` VALUES (4, '鳌峰店', 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg', '183393933', '183393933', '8:30-17:30', 0, 0, 0, '33反反复复', '', 100, 1, 1562278174, 1562333401, 10001, 10003, 1171);
INSERT INTO `yoshop_shop` VALUES (5, '33333', 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg', '333', '333', '333', 0, 0, 0, '333', '', 100, 1, 1562279747, 1562279747, 10001, 10003, 1170);
INSERT INTO `yoshop_shop` VALUES (6, '333', 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg', '33', '333', '33', 0, 0, 0, '33', '', 100, 1, 1562279800, 1562279800, 10001, 10003, 1170);
INSERT INTO `yoshop_shop` VALUES (7, '333', 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg', '333', '333', '333', 0, 0, 0, '333', '', 100, 1, 1562279848, 1562279848, 10001, 10003, 1171);
INSERT INTO `yoshop_shop` VALUES (8, 'hhhh', 'http://fit.vilay.com/uploads/201906010829226d0c72292.jpg', '444', '44', '44', 0, 0, 0, '44', '', 100, 1, 1562279952, 1562331943, 10001, 10001, 1172);
COMMIT;

-- ----------------------------
-- Table structure for yoshop_shop_banners
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_shop_banners`;
CREATE TABLE `yoshop_shop_banners` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of yoshop_shop_banners
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_shop_banners` VALUES (1, 7, 10003, 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg');
INSERT INTO `yoshop_shop_banners` VALUES (4, 8, 10003, 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg');
INSERT INTO `yoshop_shop_banners` VALUES (5, 4, 10003, 'http://fit.vilay.com/uploads/2019060108312776ec26083.jpg');
INSERT INTO `yoshop_shop_banners` VALUES (6, 4, 10002, 'http://fit.vilay.com/uploads/201906010831149a1eb8498.jpg');
COMMIT;

-- ----------------------------
-- Table structure for yoshop_shop_order
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_shop_order`;
CREATE TABLE `yoshop_shop_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shop_id` int(11) NOT NULL DEFAULT '0',
  `user_id` int(11) NOT NULL DEFAULT '0',
  `order_sn` varchar(40) NOT NULL DEFAULT '',
  `points` int(11) NOT NULL DEFAULT '0',
  `create_time` int(11) NOT NULL DEFAULT '0',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0 产生订单  10支付订单',
  `wxapp_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of yoshop_shop_order
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_shop_order` VALUES (1, 2, 10007, '20190601dd', 16, 1559399182, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (2, 3, 10006, '20190601dd', 33, 1559399182, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (3, 2, 10007, '190614083933386', 10, 1560472749, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (4, 2, 10007, '190614084065140', 10, 1560472811, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (5, 2, 10007, '190614084329134', 10, 1560472980, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (6, 2, 10007, '190614084377394', 10, 1560473020, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (7, 2, 10007, '190614084491119', 10, 1560473049, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (8, 2, 10007, '190614084654509', 5, 1560473164, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (9, 2, 10007, '190614084641835', 5, 1560473218, 10, 10001);
INSERT INTO `yoshop_shop_order` VALUES (10, 2, 10007, '190614183291815', 10, 1560508364, 10, 10001);
COMMIT;
...
-- ----------------------------
-- Records of yoshop_store_role
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_store_role` VALUES (1, '管理员', 1, 10001);
INSERT INTO `yoshop_store_role` VALUES (2, '店长', 1, 10001);
COMMIT;
...
CREATE TABLE `yoshop_store_user` (
  ...
  `shop_ids` varchar(255) NOT NULL DEFAULT '' COMMENT '门店',
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_store_user` VALUES (10001, 'admin', '54809e164b3b299d3481e13524ef410f', '', 10001, 1529926348, 1531027042, '', '', 1);
INSERT INTO `yoshop_store_user` VALUES (10003, '33', 'e8ffab69be7d5bb0029c4c8b650b24c1', '15659731452', 10001, 1559356732, 1559356732, '[\"2\",\"3\"]', '', 0);
INSERT INTO `yoshop_store_user` VALUES (10004, '444', '', '15659731451', 10001, 1559356772, 1559433030, '[\"2\"]', '[\"1\"]', 1);
INSERT INTO `yoshop_store_user` VALUES (10006, 'vilay', '54809e164b3b299d3481e13524ef410f', '15659731453', 10001, 1559432738, 1560303125, '[\"2\"]', '[\"2\"]', 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_upload_file` VALUES (10001, 'local', 0, '', '201906010829226d0c72292.jpg', 68572, 'image', 'jpg', 0, 10001, 1559348962);
INSERT INTO `yoshop_upload_file` VALUES (10002, 'local', 0, '', '201906010831149a1eb8498.jpg', 59184, 'image', 'jpg', 0, 10001, 1559349074);
INSERT INTO `yoshop_upload_file` VALUES (10003, 'local', 0, '', '2019060108312776ec26083.jpg', 6677, 'image', 'jpg', 0, 10001, 1559349087);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_user` VALUES (10006, '', 'cicy', '', 0, '', '', '', 0, 10001, 1559343199, 1559346280, 2500, 2200, '15659731452', 'ad', '54809e164b3b299d3481e13524ef410f', 1, '', 0, 0);
INSERT INTO `yoshop_user` VALUES (10007, 'ogHQB5TxdIbD1L_0ikeqioJdQRxI', 'Z朱建平', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTKgwa20FrBYwG9ld5rjEXt154lI020LJFrsicSWuk2KdMAl1whUycSzyZPgrVX3jVLnJ8m1Bl6On8Q/132', 1, '中国', '福建', '福州', 0, 10001, 1559395049, 1561551832, 600, 530, '18959193813', 'vilay', '54809e164b3b299d3481e13524ef410f', 1, 'XAdb', 1, 1);
INSERT INTO `yoshop_user` VALUES (10008, 'otlwR5aRifwy9o5SUw2IUACSYG-A', 'Z朱建平', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTKN7jcicI27PiadibHnP1TSNJ9Fz8VVmtcAZ6bB99GwZFPlkK6oBmlDdwgzibQGsNqZgn52qG3ZgBPHjw/132', 1, '中国', '福建', '福州', 0, 10001, 1562248398, 1562248398, 0, 400, '', '', '', 0, '', 0, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_wxapp` VALUES (10001, '萤火小程序商城', 'wx934a5f24d2a02a93', '3b30096bf61ae2611269c5768ea71b37', 0, 0, 0, '', 0, '', '', 1529926348, 1562248384);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_wxapp_navbar` VALUES (10001, '酷动健身', 20, '#ffdd00', 1529926348, 1559400161);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_wxapp_page` VALUES (10001, 10, '{\"items\":{\"s10001\":{\"id\":\"s10001\",\"type\":\"search\",\"params\":{\"placeholder\":\"\\u641c\\u7d22\\u5546\\u54c1\"},\"style\":{\"textAlign\":\"center\",\"searchStyle\":\"radius\"}},\"n606196612728596\":{\"id\":\"n606196612728596\",\"type\":\"banner\",\"style\":{\"btnColor\":\"#ffffff\",\"btnShape\":\"round\"},\"data\":{\"n400199453786769\":{\"imgUrl\":\"http:\\/\\/fit.vilay.com\\/uploads\\/201906010831149a1eb8498.jpg\",\"imgName\":\"http:\\/\\/fit.vilay.com\\/uploads\\/201906010831149a1eb8498.jpg\",\"linkUrl\":\"\"},\"n837367626101537\":{\"imgUrl\":\"http:\\/\\/fit.vilay.com\\/uploads\\/2019060108312776ec26083.jpg\",\"imgName\":\"http:\\/\\/fit.vilay.com\\/uploads\\/2019060108312776ec26083.jpg\",\"linkUrl\":\"\"}}}}}', 10001, 1529926348, 1559442810);
COMMIT;
