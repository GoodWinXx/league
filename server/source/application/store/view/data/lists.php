                ...
                <div class="widget-body am-fr">
                   <div class="page_toolbar am-margin-bottom-xs am-cf">
                        <form id="form-search" class="toolbar-form" action="">
                            <input type="hidden" name="s" value="/store/data/lists.html">
                            ...
                            <div class="am-u-sm-12 am-u-md-9">
                                <div class="am fr">
                                    <?php if(!$shop_id || $data_type == 'all'): ?>
                                    <div class="am-form-group am-fl">
                                        <select name="shop_id" data-am-selected="{btnSize: 'sm', placeholder: '选择门店'}" style="display: none;">
                                            <option value="">全部
                                            </option>
                                            <?php if(!empty($search['shops'])): foreach($search['shops'] as $shop): ?>
                                                <option value="<?= $shop['id'] ?>" <?php if($shop_id == $shop['id']){ echo 'selected';} ?>><?= $shop['shop_name'] ?></option>
                                ...
                                <?php endif; ?>
                                    ...
                                    <div class="am-form-group am-fl">
                                        <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                            <input type="text" class="am-form-field" name="search" placeholder="用户昵称" value="<?= $search_param['search'] ? $search_param['search'] : '' ?>">
