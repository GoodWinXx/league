                ...
                <div class="widget-body am-cf">
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__blue am-cf">
                            <div class="card-header">积分总数</div>
                            <div class="card-body">
                                <div class="card-value"><?= $total_data['all_points']?></div>
                                <div class="card-description">系统共产生积分数</div>
                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__red am-cf">
                            ...
                            <div class="card-body">
                                <div class="card-value"><?= $total_data['all_users']?></div>
                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__violet am-cf">
                            ...
                            <div class="card-body">
                                <div class="card-value"><?= $total_data['all_order_counts']?></div>
                                <div class="card-description">消费订单总数量</div>
                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__primary am-cf">
                            <div class="card-header">使用积分总量</div>
                            <div class="card-body">
                                <div class="card-value"><?= $total_data['use_points']?></div>
                                <div class="card-description">已使用的积分总数</div>
                    ...
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                        <div class="widget-outline dis-flex flex-y-center">
                            ...
                            <div class="outline-right dis-flex flex-dir-column flex-x-between">
                                <div style="color: rgb(102, 102, 102); font-size: 1.3rem;">销售额</div>
                                <div style="color: rgb(51, 51, 51); font-size: 2.4rem;"><?= $today_data['sale_total'] ?></div>
                                <div style="color: rgb(153, 153, 153); font-size: 1.2rem;">
                                    昨日：<?= $yestoday_data['sale_total'] ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                        <div class="widget-outline dis-flex flex-dir-column flex-x-between">
                            ...
                            <div style="color: rgb(51, 51, 51); font-size: 2.4rem;"><?= $today_data['sale_counts'] ?></div>
                            <div style="color: rgb(153, 153, 153); font-size: 1.2rem;">
                                昨日：<?= $yestoday_data['sale_counts'] ?></div>
                        </div>
                    </div>
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                        <div class="widget-outline dis-flex flex-y-center">
                            ...
                            <div class="outline-right dis-flex flex-dir-column flex-x-between">
                                ...
                                <div style="color: rgb(51, 51, 51); font-size: 2.4rem;"><?= $today_data['add_users'] ?></div>
                                <div style="color: rgb(153, 153, 153); font-size: 1.2rem;">
                                    昨日：<?= $yestoday_data['add_users'] ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="am-u-sm-6 am-u-md-6 am-u-lg-3">
                        <div class="widget-outline dis-flex flex-dir-column flex-x-between">
                            ...
                            <div style="color: rgb(51, 51, 51); font-size: 2.4rem;"><?= $today_data['create_order_users'] ?></div>
                            <div style="color: rgb(153, 153, 153); font-size: 1.2rem;">
                                昨日：<?= $yestoday_data['create_order_users'] ?></div>
                        </div>
                    </div>
                </div>
            </div>
