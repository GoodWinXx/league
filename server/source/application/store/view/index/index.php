                ...
                <div class="widget-body am-cf">
                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget-card card__primary am-cf">
                            <div class="card-header">积分总量</div>
                            <div class="card-body">
    ...
    <div class="row">
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 am-margin-bottom">
            <div class="widget am-cf">
                ...
                <div class="widget-body am-cf">
                    <div id="echarts-trade" class="widget-echarts" _echarts_instance_="ec_1559306743599" style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative; background: rgba(252, 252, 252, 0);"><div style="position: relative; overflow: hidden; width: 1044px; height: 400px;"><canvas width="2088" height="800" data-zr-dom-id="zr_0" style="position: absolute; left: 0px; top: 0px; width: 1044px; height: 400px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></canvas></div><div></div></div>
                </div>
            </div>
        </div>
    </div>
        ...
        series: [
            {
                name: '成交额',
                type: 'line',
                data: <?= json_encode($result['sale_money'])?>            },
            {
                name: '成交量',
                type: 'line',
                data: <?= json_encode($result['sale_count'])?>            }
        ]
    }, true);
