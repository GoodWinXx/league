...
class Worksheet extends BIFFwriter
{
    ...
    /**
     * IndexModel of first used row (at least 0).
     *
     * @var int
     */
    ...
    /**
     * IndexModel of last used row. (no used rows means -1).
     *
     * @var int
     */
    ...
    /**
     * IndexModel of first used column (at least 0).
     *
     * @var int
     */
    ...
    /**
     * IndexModel of last used column (no used columns means -1).
     *
     * @var int
     */
...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
     ...
     * @param int $xfIndex IndexModel to XF record
     */
     ...
     * @param array $arrcRun IndexModel to Font record and characters beginning
     */
    ...
    private function writeCFRule(Conditional $conditional)
    {
        ...
        if ($bFormatBorder == 1) {
            ...
            //@todo writeCFRule() => $blockLineStyle => IndexModel Color for left line
            //@todo writeCFRule() => $blockLineStyle => IndexModel Color for right line
            ...
            $blockColor = 0;
            //@todo writeCFRule() => $blockColor => IndexModel Color for top line
            //@todo writeCFRule() => $blockColor => IndexModel Color for bottom line
            //@todo writeCFRule() => $blockColor => IndexModel Color for diagonal line
