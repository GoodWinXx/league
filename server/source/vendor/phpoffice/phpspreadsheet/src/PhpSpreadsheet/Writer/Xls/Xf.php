...
class Xf
{
    ...
    /**
     * IndexModel to the FONT record. IndexModel 4 does not exist.
     *
     * @var int
     */
    private $fontIndex;
    ...
    public function writeXf()
    {
        ...
        $ifnt = $this->fontIndex; // IndexModel to FONT record
        $ifmt = $this->numberFormatIndex; // IndexModel to FORMAT record
     ...
     *
     * @param int $numberFormatIndex IndexModel to format record
     */
