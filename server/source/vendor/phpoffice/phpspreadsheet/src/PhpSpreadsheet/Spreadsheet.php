...
class Spreadsheet
{
     ...
     *
     * @param null|int $sheetIndex IndexModel where sheet should go (0,1,..., or null for last)
     *
     * @throws Exception
     *
     * @return Worksheet
     ...
     * @param null|int $iSheetIndex IndexModel where sheet should go (0,1,..., or null for last)
     *
     * @throws Exception
     *
     * @return Worksheet
     ...
     *
     * @param int $pIndex IndexModel to cellXf
     *
     * @throws Exception
     */
