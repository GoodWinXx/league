...
class Xls extends BaseReader
{
    ...
    /**
     * Return worksheet info (Name, Last Column Letter, Last Column IndexModel, Total Rows, Total Columns).
     *
     * @param string $pFilename
     *
     * @throws Exception
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    switch ($obj['otObjType']) {
                        ...
                        case 0x08:
                            ...
                            // If there is no BSE IndexModel, we will fail here and other fields are not read.
                            // Fix by checking here.
                            // TODO: Why is there no BSE IndexModel? Is this a new Office Version? Password protected field?
...
//                                                    ->setAuthor($author)
    ...
    private function readXf()
    {
        ...
        if (!$this->readDataOnly) {
            // offset:  0; size: 2; IndexModel to FONT record
            ...
            // offset:  2; size: 2; IndexModel to FORMAT record
